...
const title = 'Wanderburg Modules Wiki (0.9.14): Effects & Patch Changes';
const h1 = 'Wanderburg Modules Wiki (0.9.14)';
const description = 'Wanderburg modules reference for Early Access 0.9.14, covering Electric Mage, Side Arms, Front Barracks, Side Ballista, Force Mage, Back Turret, Fire Mage, Top Mortar and Ram.';
...
const toc = [
  'Quick Module Reference', 'Electric Mage', 'Side Arms', 'Front Barracks', 'Side Ballista',
  'Force Mage', 'Back Turret', 'Fire Mage', 'Top Mortar', 'Ram', 'Module Rerolls',
  'Locked Module Options', 'Are These All Wanderburg Modules?', 'Why Some Community Module Lists Are Longer',
  'Modules vs Builds', 'Version History to Watch', 'Sources',
];
